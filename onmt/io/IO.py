...
from onmt.io.DatasetBase import PAD_WORD, BOS_WORD, EOS_WORD, UNK
...
def merge_vocabs(vocabs, vocab_size=None):
    ...
    return torchtext.vocab.Vocab(merged,
                                 specials=[UNK, PAD_WORD, BOS_WORD, EOS_WORD],
                                 max_size=vocab_size)
...
def build_dataset(fields, data_type, src_path, tgt_path, ref_path, src_dir=None,
                  src_seq_length=0, tgt_seq_length=0,
                  src_seq_length_trunc=0, tgt_seq_length_trunc=0, ref_seq_length_trunc=0,
    ...
    ref_examples_iter, num_ref_feats = \
        TextDataset.make_text_examples_nfeats_tpl(
            ref_path, ref_seq_length_trunc, "ref")

    if data_type == 'text':
        dataset = TextDataset(fields, src_examples_iter, tgt_examples_iter, ref_examples_iter,
