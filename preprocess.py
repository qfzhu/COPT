...
def build_save_text_dataset_in_shards(src_corpus, tgt_corpus, ref_corpus, fields,
                                      corpus_type, opt):
    '''
    ...
    tgt_iter = onmt.io.ShardedTextCorpusIterator(
                ...
                assoc_iter=src_iter)
    ref_iter = onmt.io.ShardedTextCorpusIterator(
    ...
    while not src_iter.hit_end():
        ...
        dataset = onmt.io.TextDataset(
                fields, src_iter, tgt_iter, ref_iter,
                src_iter.num_feats, tgt_iter.num_feats,
                src_seq_length=opt.src_seq_length,
                tgt_seq_length=opt.tgt_seq_length,
                ref_seq_length=opt.ref_seq_length,
...
def build_save_dataset(corpus_type, fields, opt):
    ...
    if opt.data_type == 'text':
        return build_save_text_dataset_in_shards(
                src_corpus, tgt_corpus, ref_corpus, fields,
                corpus_type, opt)
