...
def preprocess_opts(parser):
    ...
    group.add_argument('-train_ref', required=True,
    ...
    group.add_argument('-valid_ref', required=True,
    ...
    group.add_argument('-ref_seq_length', type=int, default=500,
                       help="Maximum reference sequence length to keep.")
    group.add_argument('-ref_seq_length_trunc', type=int, default=0,
...
def train_opts(parser):
    ...
    group.add_argument('-training_mode', type=str, default='adv',
                       help="""can be 'pre_g', 'pre_d', and 'adv' """)
    ...
    group.add_argument('-pre_g_optim', default='sgd',
                       choices=['sgd', 'adagrad', 'adadelta', 'adam'],
                       help="""Optimization method.""")
    group.add_argument('-adv_g_optim', default='adam',
                       choices=['sgd', 'adagrad', 'adadelta', 'adam'],
                       help="""Optimization method.""")
    group.add_argument('-pre_d_optim', default='adam',
                       choices=['sgd', 'adagrad', 'adadelta', 'adam'],
                       help="""Optimization method.""")
    group.add_argument('-adv_d_optim', default='adam',
                       choices=['sgd', 'adagrad', 'adadelta', 'adam'],
                       help="""Optimization method.""")
    ...
    group.add_argument('-pre_g_learning_rate', type=float, default=1,
                       help="""Starting learning rate.
                           Recommended settings: sgd = 1, adagrad = 0.1,
                           adadelta = 1, adam = 0.001""")
    group.add_argument('-adv_g_learning_rate', type=float, default=0.00001,
                       help="""Starting learning rate.
                       Recommended settings: sgd = 1, adagrad = 0.1,
                       adadelta = 1, adam = 0.001""")
    group.add_argument('-pre_d_learning_rate', type=float, default=0.0001,
                       help="""Starting learning rate.
                               Recommended settings: sgd = 1, adagrad = 0.1,
                               adadelta = 1, adam = 0.001""")
    group.add_argument('-adv_d_learning_rate', type=float, default=0.00001,
                       help="""Starting learning rate.
                           Recommended settings: sgd = 1, adagrad = 0.1,
                           adadelta = 1, adam = 0.001""")
...
def translate_opts(parser):
    ...
    group.add_argument('-ref', required=True,
                       help="""Source sequence to decode (one line per
                           sequence)""")
